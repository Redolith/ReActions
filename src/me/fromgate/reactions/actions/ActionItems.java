...
public class ActionItems extends Action {
	...
	public boolean execute(Player p, Param params) {
		switch (actionType){
		case 0: return giveItemPlayer(p,params.getParam("param-line", ""));
		...
		case 5: return openInventory(p,params.getParam("param-line", ""));
		case 6: return setInventorySlot (p,params);
		case 7: return unwearItem (p,params);
		}
		return true;
	}
	...
	private boolean unwearItem(Player player, Param params) {
		...
		if (slot==-1&&!itemStr.isEmpty()){
			...
			if (itemStr.isEmpty()||ItemUtil.compareItemStr(itemSlot, itemStr)) vi = ItemUtil.itemFromItemStack(itemSlot);
		}
