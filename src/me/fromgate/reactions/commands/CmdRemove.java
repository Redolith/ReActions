		...
		if (arg1.equalsIgnoreCase("act")||	arg1.equalsIgnoreCase("activator")){
			...
			if (ReActions.getUtil().isIntegerGZ(arg3)) {
				...
				if (arg2.equalsIgnoreCase("f")||arg2.equalsIgnoreCase("flag")){
					if (act.removeFlag(num-1)) ReActions.getUtil().printMSG(sender, "msg_flagremoved",act.getName(),num);
					...
					if (act.removeAction(num-1)) ReActions.getUtil().printMSG(sender, "msg_actionremoved",act.getName(),num);
					...
					if (act.removeReaction(num-1)) ReActions.getUtil().printMSG(sender, "msg_reactionremoved",act.getName(),num);
